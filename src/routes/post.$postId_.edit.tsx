...
function EditPage() {
  ...
  return (
    <ClientOnly fallback={null}>
      {/* Login gating: editing is author-only, so it requires a session (guests
          count — they share the backend's `guest` identity); the journey
          itself re-checks authorship once the post loads. */}
      <AuthGate>
